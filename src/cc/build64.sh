...
function compile_prolog {
    ...
    ${_HOME}/src/tvision/build/tvhc${exeSuffix} prolog64.txt prolog64.hlp help.h > /dev/null 2>&1
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    strip_file ${_HOME}/src/prolog/prolog64${exeSuffix}
	#
