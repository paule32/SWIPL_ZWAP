    ...
    void* lpReserved)
{
    ...
    switch (reason) {
        case DLL_PROCESS_ATTACH:
        {
            ...
            globsl_tt_type[ tt_print_one     ] = "print one";     // ?  with new line after string
            globsl_tt_type[ tt_print_two     ] = "print two";     // ?? no   ...

            globsl_tt_type[ tt_for_loop	     ] = "for loop";      // for <ident> := 0 to 9

            globsl_tt_type[ tt_class_obj     ] = "class obj";     // e.g.:  CLASS ... ENDCLASS
            globsl_tt_type[ tt_class_ref     ] = "class ref";     // e.g.:  local f = Form1()
